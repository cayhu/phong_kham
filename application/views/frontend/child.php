		...
		<div class="row">
			<div class="col-xs-12 a-center">
				<ul class="breadcrumb" itemscope itemtype="">					
					...
					<li><strong ><a href="<?php echo base_url(); ?><?php echo vntoen($menuparent)."-".$menuparentid.".htm"; ?>"><span itemprop="title"><?php echo $menuparent; ?></span></strong></a> <span class="mr_lr">&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span></li>
