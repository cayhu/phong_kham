		...
		<div class="row">
			<div class="col-xs-12 a-center">
				<ul class="breadcrumb" itemscope itemtype="">					
					...
					<li><a href="<?php echo base_url(); ?>tin-tuc.htm"><strong ><span itemprop="title">
						</span>Tin tức</strong></a> <span class="mr_lr">&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span></li>
...
<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="article_lq section">
		...
		<?php foreach ($this->phongkham->get_data_where("tbl_news",array('id !='=>$dt['id'])) as $oder) {
	$urlpost=base_url()."tin-tuc/".vntoen($oder['title'])."-".$oder['id'].".html";
			 ?>
