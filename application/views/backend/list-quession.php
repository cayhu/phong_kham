...
<div class="content-wrapper">
        ...
        <h1> &nbsp;</h1>
          <ol class="breadcrumb">
            ...
            <li class="active">Danh sách câu hỏi thường gặp</li>
          </ol>
        </section>
        <!-- Main content -->
...
<div class="row">
  ...
  <?php if(isset($_GET['err']) && $_GET['err']!=null &&  $_GET['err']==1){ ?>
    ...
    <div class="box box-primary">
                ...
                <div class="box-body">
                <div><a class="btn btn-success btn-flat" href="<?php echo base_url(); ?>cadmin/addnews"><span class="fa fa-pencil-square"></span> Thêm mới</a><hr></div>
                    ...
                    <?php $i=0; foreach ($data as $k) {
                     ...
                     ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url();?>cadmin/updatequession/<?php echo $k['id']; ?>" class="btn btn-primary btn-xs"> <span class="fa fa-edit"></span> Edit</a>
                          <a href="<?php echo base_url();?>cadmin/deletequession/<?php echo $k['id']; ?>" class="btn btn-danger btn-xs"><span class='fa fa-trash'></span> Delete</a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
