  ...
  <div class="alert alert-danger alert-dismissable">
    ...
    <div class="box box-primary">
                <div class="box-header with-border">
                 ...
                 <form role="form" action="<?php echo base_url(); ?>cadmin/prosess_add_post" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <select id="cate" name="cate" required class="form-control">
                    ...
                    foreach ($this->madmin->get_data_where("tbl_menu",array('parent'=>$cates['id'])) as $cate) {
                     ?>
                         <option value="<?php echo $cates['id']."/".$cate['id']; ?>"><?php echo $cate['title']; ?></option>
                    <?php } ?>
                     </optgroup>      
