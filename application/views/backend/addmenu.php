...
<div class="row">
  ...
  <?php if(isset($_GET['err']) && $_GET['err']!=null &&  $_GET['err']==1){ ?>
    ...
    <div class="box box-primary">
                ...
                <div class="box-body">
                 <form role="form" action="<?php echo base_url(); ?>cadmin/prosess_add_menu" method="post" enctype="multipart/form-data">
                  <div class="col-md-12 mol-lg-12">
                   <div class="form-group">
                      <label for="exampleInputEmail1">Tên danh mục tiếng việt</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" name="title" placeholder="Nhập tiêu đề" required>
                    </div>
                  </div>
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <select name="parent" id="" class="form-control">
                        <option value="yes"> Danh mục chính </option>
                        <?php foreach ($this->madmin->get_data_where("tbl_menu",array('level'=>1)) as $key) { ?>
