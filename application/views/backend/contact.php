...
<div class="content-wrapper">
        ...
        <h1> &nbsp;</h1>
          <ol class="breadcrumb">
            ...
            <li class="active">Danh sách hẹn</li>
          </ol>
        </section>
        <!-- Main content -->
                     ...
                     ?>
                      <tr>
                       ...
                       <?php echo $k['name']; ?>
                        ...
                        <td>
                          <a href="<?php echo base_url();?>cadmin/deletecontact/<?php echo $k['id']; ?>" class="btn btn-danger btn-xs"><span class='fa fa-trash'></span> Delete</a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
