                    ...
                    <?php $i=0; foreach ($data as $k) {
                     ...
                     ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url();?>cadmin/updatenews/<?php echo $k['id']; ?>" class="btn btn-primary btn-xs"> <span class="fa fa-edit"></span> Edit</a>
                          <a href="<?php echo base_url();?>cadmin/deletenews/<?php echo $k['id']; ?>" class="btn btn-danger btn-xs"><span class='fa fa-trash'></span> Delete</a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
