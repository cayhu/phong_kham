  ...
  <?php if(isset($_GET['err']) && $_GET['err']!=null &&  $_GET['err']==1){ ?>
    ...
    <div class="box box-primary">
                     ...
                     ?>
                      <tr>
                        ...
                        <strong><?php echo $k['ngaydat']; ?></strong>
                         ...
                         <td>
                        <strong style="color: red"><?php echo number_format($k['price']*$k['numday'],0,",","."); ?></strong> VNĐ
                        </td>
                        <td>
                       <?php  if($k['status']==0){
              echo "<b style='color:red'>Chưa xử lý </b><br>";
              echo "<a href='".base_url()."cadmin/update_status_book/2/".$k['id']."'>Hủy đơn hàng</a><br>";
              echo "<a href='".base_url()."cadmin/update_status_book/1/".$k['id']."'>Chuyển sang đã xử lý</a><br>";
              }
              if($k['status']==1){
              ...
              echo "<b style='color:#000'>Đã hủy </b>";
                        ...
                        <td>
                          <a href="<?php echo base_url();?>cadmin/viewroom/<?php echo $k['id']; ?>" class="btn btn-success btn-xs"><span class='fa fa-eye'></span> Xem </a>
                          <a href="<?php echo base_url();?>cadmin/deletebookroom/<?php echo $k['id']; ?>" class="btn btn-danger btn-xs"><span class='fa fa-trash'></span> Xóa</a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
