  ...
  <div class="alert alert-danger alert-dismissable">
    ...
    <div class="box box-primary">
                <div class="box-header with-border">
                 ...
                 <form role="form" action="<?php echo base_url(); ?>cadmin/prosess_update_hotel/<?php echo $dt['id']; ?>" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                  <div class="form-group">
                  <select id="cate" name="cate" required class="form-control">
                    <option value="">Chọn một loại</option>
                    <option value="1" <?php if($dt['type']==1){ echo "selected";} ?>>Khách sạn</option>
                    <option value="2" <?php if($dt['type']==2){ echo "selected";} ?>>Resort</option>
                    <option value="3" <?php if($dt['type']==3){ echo "selected";} ?>>Homestay</option>
                  </select>
                  </div>
                  ...
                  <input type="hidden" name="limg" value="<?php echo $dt['imgs']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="address" placeholder="" value="<?php echo $dt['address']; ?>">
                    </div>
                  <div class="form-group">
