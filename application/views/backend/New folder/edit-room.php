  ...
  <div class="alert alert-danger alert-dismissable">
    ...
    <div class="box box-primary">
                ...
                <?php foreach ($data as $dt) ?>
                 <form role="form" action="<?php echo base_url(); ?>cadmin/prosess_update_room/<?php echo $dt['id']; ?>" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                  <input type="hidden" value="<?php echo $hotel; ?>" name="hotel">
                  <div class="form-group">
                      <label for="exampleInputEmail1">Tiêu đề </label>
                      <input type="text" class="form-control" name="title" placeholder="Nhập tiêu đề" required value="<?php echo $dt['title']; ?>">
                   </div>
                  <div class="box-body">
                  ...
                  <input type="hidden" name="limgs" value="<?php echo $dt['imgs']; ?>">
                  </div>  
                    <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <textarea id="editor2" name="editor2" rows="10" cols="80" placeholder="Nội dung "><?php echo addslashes($dt['content_vi']); ?></textarea>
                    ...
                    <button type="submit" class="btn btn-info pull-right"><span class="fa fa-plus"></span> Cập nhật</button>
                  </div>
                  </form>
    </div>
  </div>
