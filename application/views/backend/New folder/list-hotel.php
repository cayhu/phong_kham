...
<div class="row">
  ...
  <?php if(isset($_GET['err']) && $_GET['err']!=null &&  $_GET['err']==1){ ?>
    ...
    <div class="box box-primary">
                ...
                <div class="box-body">
                <div><a class="btn btn-success btn-flat" href="<?php echo base_url(); ?>cadmin/addhotel"><span class="fa fa-pencil-square"></span> Thêm mới</a><hr></div>
                <br>
                    ...
                    <?php $i=0; foreach ($data as $k) {
                     ...
                     ?>
                      <tr>
                        <td> <?php echo $i; ?> </td>
                        <td>
                          <a href="<?php echo base_url();?>cadmin/addroom/<?php echo $k['id']; ?>" class="btn btn-primary btn-xs"> <span class="fa fa-pencil-square"></span> Thêm 
                          phòng </a>
                          <a href="<?php echo base_url();?>cadmin/listroom/<?php echo $k['id']; ?>" class="btn btn-primary btn-xs"> <span class="fa fa-edit"></span> Danh sách phòng</a></td>
                        <td>
                        <img width="150" height="100" src="<?php echo base_url();?>public/images/<?php echo $k['img'];?>">
                        </td>
                        <td><?php echo $k['title_vi']; ?></td>
                        <td><?php if($k['type']==1){ echo "Khách sạn";}else if($k['type']==2) {echo "Resort";}else{ echo "Homestay";}?></td>
                        <td>
                          <a href="<?php echo base_url();?>cadmin/updatehotel/<?php echo $k['id']; ?>" class="btn btn-primary btn-xs"> <span class="fa fa-edit"></span> Edit</a>
                          <a href="<?php echo base_url();?>cadmin/deletehotel/<?php echo $k['id']; ?>" class="btn btn-danger btn-xs"><span class='fa fa-trash'></span> Delete</a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
