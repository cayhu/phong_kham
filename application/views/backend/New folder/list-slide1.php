...
<div class="row">
  ...
  <?php if(isset($_GET['err']) && $_GET['err']!=null &&  $_GET['err']==1){ ?>
    ...
    <div class="box box-primary">
                ...
                <div class="box-body">
                <div><a class="btn btn-success btn-flat" href="<?php echo base_url(); ?>cadmin/addslide1"><span class="fa fa-pencil-square"></span> Thêm mới</a><hr></div>
                     ...
                     ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url();?>cadmin/deleteslide1/<?php echo $k['id']; ?>" class="btn btn-danger btn-xs"><span class='fa fa-trash'></span> Delete</a>
                        </td>
                      </tr>
                    <?php } ?>  
                    </tbody>
