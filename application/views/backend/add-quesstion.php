...
<div class="content-wrapper">
        ...
        <h1> &nbsp;</h1>
          <ol class="breadcrumb">
            ...
            <li class="active">Thêm câu hỏi thường gặp</li>
          </ol>
        </section>
        <!-- Main content -->
  ...
  <?php if(isset($_GET['err']) && $_GET['err']!=null &&  $_GET['err']==1){ ?>
    ...
    <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Thêm câu hỏi thường gặp</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                 <form action="<?php echo base_url(); ?>cadmin/prosess_add_quesstion" method="post" enctype="multipart/form-data">
                 <div class="col-md-12 col-lg-12">
                    <div class="form-group">
                      <span>Tiêu đề </span>
                     <input type="text" name="title" class="form-control" required autocomplete="false" style="width:100%" placeholder="Tiêu đề tin">
                    </div>  
                 </div>
                  <div class="box-body">
            
                  <div class="form-group"><input class="form-control" type="file" name="img" id="title" required autocomplete="false" required  style="width:100%"></div>  
                  <div class="form-group">
                    <span>Nội dung </span>
